...
{ t:'pause', if:R },
{ t:'nar', tx:'Antoniette levou um tempo para entender que aquilo era pergunta.', if:R },
...
{ t:'pause', if:R },
{ t:'nar', tx:'Escreveu o nome dele. Depois parou por tempo suficiente para a tinta secar na pena.', if:R },
{ t:'pause', if:R },
...
{ t:'nar', tx:'Cordel em quatro voltas e um n\u00f3 cego, do jeito que se amarra o que n\u00e3o deve abrir sozinho na estrada.', if:R },
{ t:'pause', if:R },
